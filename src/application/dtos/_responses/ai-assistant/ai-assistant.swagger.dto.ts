...
export class AIAssistantFeatureSwaggerDto {
  @ApiProperty({
...
export class AIAssistantSwaggerDto {
  @ApiProperty({
  ...
  @ApiProperty({
    ...
    type: [AIAssistantFeatureSwaggerDto],
  })
  features: AIAssistantFeatureSwaggerDto[];
}

export class CompanyAIAssistantSwaggerDto {
  @ApiProperty({
  ...
  assistant: AIAssistantSwaggerDto;
}
