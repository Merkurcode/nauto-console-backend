...
/**
 * DTO for updating company AI configuration
 * Following Clean Architecture: Application layer DTOs for input validation
 * PUT endpoint will replace the entire JSON with received data
 */
export class UpdateCompanyAIConfigDto implements ICompanyConfigAI {
  @ApiProperty({
